...
- **[context-safety](/plugins/reference/context-safety)** (`@openclaw/context-safety`) - included in OpenClaw. Bounds tool inputs, persisted tool results, aggregate turn output, and provider preflight context.
