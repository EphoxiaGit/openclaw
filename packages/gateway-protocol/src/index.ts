...
import {
  ...
  CompanionBootstrapSchema,
  type CompanionCancelParams,
  CompanionCancelParamsSchema,
  type CompanionCancelResult,
  CompanionCancelResultSchema,
  type CompanionDetachParams,
  CompanionDetachParamsSchema,
  type CompanionDetachResult,
  CompanionDetachResultSchema,
  type CompanionEvent,
  CompanionEventSchema,
  type CompanionSemanticCommand,
  CompanionSemanticCommandSchema,
  type AgentEvent,
  AgentEventSchema,
  type AuditEvent,
  AuditEventSchema,
...
export type {
  CompanionAttachParams,
  CompanionAttachResult,
  CompanionBootstrap,
  CompanionCancelParams,
  CompanionCancelResult,
  CompanionDetachParams,
  CompanionDetachResult,
  CompanionEvent,
