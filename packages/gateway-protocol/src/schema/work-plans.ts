...
const WorkPlanWorkerSchema = Type.Object(
  {
    ...
    requestedProvider: Type.Optional(NonEmptyString),
    requestedModel: Type.Optional(NonEmptyString),
    actualProvider: Type.Optional(NonEmptyString),
    actualModel: Type.Optional(NonEmptyString),
    routeSource: Type.Union([
      Type.Literal("task_override"),
      Type.Literal("agent_policy"),
      Type.Literal("automatic_fallback"),
      Type.Literal("unknown"),
    ]),
    exactModel: Type.Union([
    ...
    fallbackReason: Type.Optional(Type.String({ maxLength: 1_000 })),
    pacing: Type.Union([
    ...
    quotaLane: Type.Optional(NonEmptyString),
