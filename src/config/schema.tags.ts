...
const TAG_OVERRIDES: Record<string, ConfigTag[]> = {
  ...
  "gateway.controlUi.companionEnabled": ["security", "access", "advanced"],
  "gateway.controlUi.companionRenderer": ["security", "access", "advanced"],
  "gateway.controlUi.companionPresentation": ["advanced"],
  "gateway.controlUi.allowExternalEmbedUrls": ["security", "access", "network", "advanced"],
  "gateway.controlUi.chatMessageMaxWidth": ["advanced"],
  "workspace.liveWork.visible": ["advanced"],
  "workspace.liveWork.showContinueDraft": ["advanced"],
