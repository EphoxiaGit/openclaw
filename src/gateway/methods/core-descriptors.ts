...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "personas.list", scope: "operator.read" },
  { name: "personas.get", scope: "operator.read" },
  { name: "personas.create", scope: "operator.write" },
  { name: "personas.update", scope: "operator.write" },
  { name: "personas.revise", scope: "operator.write" },
  { name: "personas.archive", scope: "operator.write" },
  { name: "personas.restore", scope: "operator.write" },
  { name: "personas.delete", scope: "operator.write" },
  ...
  { name: "personas.affect.impulse", scope: "operator.write" },
  { name: "personas.experiments.propose", scope: "operator.write" },
  { name: "personas.experiments.accept", scope: "operator.write" },
  ...
  { name: "personas.memory.delete", scope: "operator.write" },
  { name: "personas.memory.export", scope: "operator.read" },
  { name: "work.inputs.list", scope: "operator.read" },
  { name: "work.inputs.get", scope: "operator.read" },
  { name: "work.inputs.resolve", scope: "operator.write" },
  { name: "work.inputs.cancel", scope: "operator.write" },
  { name: "work.projects.create", scope: "operator.write" },
  { name: "work.registeredProjects.list", scope: "operator.read" },
  { name: "work.registeredProjects.get", scope: "operator.read" },
  { name: "work.projects.createRegistered", scope: "operator.write" },
  { name: "work.projectContext.get", scope: "operator.read" },
  { name: "work.documents.list", scope: "operator.read" },
  { name: "work.documents.get", scope: "operator.read" },
  { name: "work.capsules.update", scope: "operator.write" },
  { name: "work.checkpoints.create", scope: "operator.write" },
  ...
  { name: "work.plans.history", scope: "operator.read" },
  { name: "work.plans.projection", scope: "operator.read" },
  ...
  { name: "companion.attach", scope: "operator.read" },
  { name: "companion.detach", scope: "operator.read" },
  { name: "companion.cancel", scope: "operator.write" },
] as const;
