...
const SETTINGS_ROUTE_PATHS = [
  ...
  { routeId: "workspace", path: "/settings/workspace", alias: "/workspace" },
  { routeId: "automation", path: "/settings/automation", alias: "/automation" },
  { routeId: "security", path: "/settings/security", alias: "/security" },
...
describe("subtitleForRoute", () => {
  it("returns expected subtitles for every route", () => {
    expect(
      ...
      workspace: "Native workspace and live-work presentation settings.",
      automation: "Commands, hooks, cron, and plugins.",
      security: "Security policy, approvals, access, authentication, and secrets.",
