...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      detailSubtitle:
        "Personen müssen genehmigt werden, bevor ihre Direktnachrichten den Agenten erreichen.",
      ...
      approveExplanation:
        "Dadurch kann der Absender mit dem Agenten in Direktnachrichten kommunizieren. Es gewährt keinen Gruppenzugriff.",
      dismissExplanation:
        "Dadurch wird die aktuelle Anfrage entfernt, der Absender wird jedoch nicht blockiert. Er kann später erneut Zugriff anfordern.",
      notifyRequester: "Anfragenden nach der Genehmigung benachrichtigen",
      makeCommandOwner: "Diesen Absender außerdem zum ersten Befehlseigentümer machen",
      commandOwnerHelp:
        "Befehlseigentümer können privilegierte Befehle ausführen und gefährliche Aktionen genehmigen. Diese Option ist nur verfügbar, solange kein Eigentümer konfiguriert ist.",
      commandOwnerNeedsAdmin:
        "Es ist kein Befehlseigentümer konfiguriert. Diese Verbindung benötigt operator.admin, um den ersten Eigentümer zuzuweisen.",
      approvedNotice: "DM-Zugriff genehmigt.",
      approvedOwnerNotice:
        "DM-Zugriff genehmigt und der erste Befehlseigentümer wurde konfiguriert.",
      ...
      approvedOwnerFailedNotice:
        "DM-Zugriff genehmigt, aber der erste Befehlseigentümer konnte nicht konfiguriert werden.",
      approvedFollowupsFailedNotice:
        "DM-Zugriff genehmigt, aber sowohl die Benachrichtigung des Anfragenden als auch die Einrichtung des Befehlseigentümers sind fehlgeschlagen.",
      dismissedNotice: "DM-Zugriffsanfrage verworfen. Der Absender kann erneut Zugriff anfordern.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Sie ist möglicherweise bereits nicht mehr vorhanden oder ihr Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Sie haben die App noch nicht?",
  ...
  sessionsView: {
    ...
    invalidEmojiIcon: "Gib genau ein Emoji ein.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG oder WebP. Bilder werden mittig zugeschnitten und auf 512px skaliert.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Benachrichtigungen werden nativ von der OpenClaw-App auf diesem Mac angezeigt.",
      ...
      nativeBlockedHint:
        "Benachrichtigungen für OpenClaw sind in macOS deaktiviert. Erlauben Sie sie unter Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sessionObserver: {
      ...
      hint: "Fasse langlaufende Sitzungen mit einem kleinen Utility-Modell zusammen.",
      toggle: "Sitzungsbeobachter",
      toggleHint: "Live-Statusübersichten für abonnierte Control-UI-Sitzungen erzeugen.",
      ...
      modelPickerHint:
        "Wird für Beobachterübersichten und andere kurze Utility-Aufgaben verwendet.",
      modelCatalogUnavailable: "Expliziter Modellkatalog nicht verfügbar",
      auto: "Automatisch (Anbieter-Standard)",
      disabled: "Deaktiviert",
      toggleNote: "Control-UI-Sitzungsbeobachter aktualisieren",
      modelNote: "Standard-Utility-Modell aktualisieren",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    security: "Gateway-Authentifizierung, Exec-Richtlinie, Tool-Profil und Genehmigungen.",
    advanced: "Alle übrigen Konfigurationsbereiche sowie der Rohdatei-Editor.",
  ...
  custodian: {
    ...
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Versuche es erneut, um diese Einrichtung fortzusetzen.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "Formatierung oder Kommentare geändert, ohne sichtbare Änderungen am Konfigurationspfad.",
      sources: {
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie Ein-Klick-Connectoren auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  sessionsPage: {
    hubTablistLabel: "Thread-Abschnitte",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    sectionDescription:
      "Änderungen werden sofort gespeichert und gelten für künftige Agent-Ausführungen.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Lassen Sie Agenten Tools in kompakten, sandbox-isolierten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Telefon, Ihre Uhr, Ihren Desktop und Ihren Browser – plus Plugins, um die Fähigkeiten Ihres Agenten zu erweitern.",
    sectionMobile: "Auf Ihrem Telefon",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Übersichtliche Chats und Schnellantworten von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleit-App für dein Gateway – Benachrichtigungen, Genehmigungen, schneller Chat.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "Identität wird geladen…",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wählen Sie ein Bild, das 10 MB oder kleiner ist.",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleTitle: "Diese angepinnte App ist veraltet",
      appStaleDetail:
      ...
      sandboxOriginRequired:
        "Widget-Autorisierung nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn das Gateway hinter einem Reverse-Proxy oder Tunnel läuft, der den Widget-Sandbox-Port nicht weiterleitet, legen Sie mcp.apps.sandboxOrigin auf einen dedizierten öffentlichen Origin fest, der an den Sandbox-Listener geroutet wird.",
      errorTitle: "Dieses Widget konnte nicht geladen werden",
      errorDetail: "Das Problem beschränkt sich auf diese Karte.",
      actionErrorTitle: "Widget-Änderung fehlgeschlagen",
      actionErrorDetail: "Das Dashboard hat den vorherigen Widget-Zustand beibehalten.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Der Branch-Wechsel ist nicht verfügbar, während der Agent arbeitet.",
      branchSwitchRequiresAdmin:
        "Für den Branch-Wechsel ist Operator-Administratorzugriff erforderlich.",
    ...
    board: {
      ...
      mockRecentFindings: "Neueste Erkenntnisse",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw hat deine lokalen Versionen behalten und die anderen Cloud-Änderungen angewendet. Überprüfe das bereitgestellte Ergebnis oder übernimm die Version für einen konfliktbehafteten Pfad.",
      morePaths: "+{count} weitere Pfade",
      stagedResult: "Bereitgestelltes Cloud-Ergebnis",
      copyStagedResult: "Ref des bereitgestellten Ergebnisses kopieren",
      inspectCloud: "Erste Cloud-Version prüfen",
      takeCloud: "Erste Cloud-Version übernehmen",
      copyInspectCommand: "Cloud-Prüfbefehl kopieren",
      copyTakeCommand: "take-cloud-Befehl kopieren",
      commandHelp:
        "Führe diese in Bash oder zsh aus (Git Bash unter Windows). Wenn inspect meldet, dass der Pfad nicht existiert, hat die Cloud ihn gelöscht; überprüfe dies und entferne den lokalen Pfad manuell. Wenn checkout einen Datei/Verzeichnis-Konflikt meldet, verschiebe oder entferne den blockierenden lokalen Pfad und versuche es erneut. Wenn die bereitgestellte Ref fehlt, ist der Hinweis veraltet; ändere den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, daher erstellt OpenClaw dafür keinen kopierbaren Shell-Befehl. Prüfe die bereitgestellte Ref direkt und gib den Pfad manuell mit Sorgfalt ein.",
      dismiss: "Hinweis zum Workspace-Konflikt ausblenden",
    ...
    questions: {
      ...
      submitFailed: "Übermittlung fehlgeschlagen: {error}",
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Zur Zeit vor dieser Nachricht zurückspulen?",
    ...
    observer: {
      title: "Sitzungsbeobachter",
      expand: "Sitzungsbeobachter ausklappen",
      collapse: "Sitzungsbeobachter einklappen",
      hide: "Sitzungsbeobachter ausblenden",
      show: "Sitzungsbeobachter anzeigen",
      plan: "Plan",
      ...
      askLabel: "Zu dieser Sitzung fragen",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden wirksam, wenn du deine nächste Talk-Sitzung startest.",
      ...
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste im Eingabefeld gedrückt, sprechen Sie und lassen Sie los, um Text einzufügen, ohne ihn zu senden.",
      dictationAudioUnsupported:
        "Der Gateway hat ein nicht unterstütztes Diktier-Audioformat zurückgegeben.",
      ...
      dictationDisconnected:
        "Diktat wurde beendet, weil die Verbindung zum Gateway getrennt wurde.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Skript",
      readOnlyPayloadHelp:
        "Dieser Payload wurde außerhalb der Control UI erstellt. Sein Inhalt bleibt schreibgeschützt und wird beibehalten, wenn Sie andere Änderungen speichern.",
