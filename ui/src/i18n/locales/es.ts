...
export const es: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      dismissExplanation:
        "Esto elimina la solicitud actual, pero no bloquea al remitente. Podrá solicitar acceso de nuevo más adelante.",
      notifyRequester: "Notificar al solicitante tras la aprobación",
      ...
      approvedFollowupsFailedNotice:
        "Acceso a mensajes directos aprobado, pero fallaron tanto la notificación al solicitante como la configuración del propietario de comandos.",
      dismissedNotice:
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se borró ninguna sesión almacenada de WhatsApp. Es posible que ya no exista, o que su directorio de autenticación requiera una limpieza manual.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Sin conexión: abre Configuración",
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "No se pudo verificar Git para esta carpeta. Vuelve a seleccionarla para reintentar.",
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "Worker en la nube: {state} · 1 conflicto de área de trabajo",
    cloudWorkerPlacementConflicts:
      "Worker en la nube: {state} · {count} conflictos de área de trabajo",
    cloudWorkerDescendantConflict: "Worker en la nube secundario: 1 conflicto de área de trabajo",
    cloudWorkerDescendantConflicts:
      "Workers en la nube secundarios: {count} conflictos de área de trabajo",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG o WebP. Las imágenes se recortan al centro y se ajustan a 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Las notificaciones las muestra de forma nativa la app de OpenClaw en este Mac.",
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Elige qué aparece mientras las sesiones están en ejecución.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw inició una nueva sesión; los mensajes anteriores se conservan como contexto.",
    ...
    history: {
      ...
      opaqueChange:
        "Se cambió el formato o los comentarios sin cambios visibles en las rutas de configuración.",
      sources: {
  ...
  mcpServers: {
    ...
    targetInvalid:
      "Introduce una URL para los transportes HTTP o una línea de comandos válida para stdio.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "El complemento de Android extiende OpenClaw a tu reloj.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "El complemento de Windows conecta tu PC como un nodo de OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      ...
      openSettings: "Abrir ajustes de identidad para {name}",
      avatarErrors: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Seguimiento automático",
    file: "Archivo: {file}",
    truncated: "Salida de registro truncada; se muestra el fragmento más reciente.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsada Alt y presiona una flecha para moverlo.",
      ...
      rejectedDetail: "Este widget permanece inactivo hasta que se elimine o se reemplace.",
      ...
      sandboxOriginRequired:
        "La autorización del widget falló tras varios intentos de actualización. Si el gateway se ejecuta detrás de un proxy inverso o túnel que no enruta el puerto del sandbox del widget, define mcp.apps.sandboxOrigin en un origen público dedicado enrutado al listener del sandbox.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Aún no hay panel — el agente de trabajo puede fijar widgets.",
    openSession: "Abrir sesión",
  ...
  modelProviders: {
    ...
    globalUsage: "Uso y costo global",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "El cambio de rama no está disponible mientras el agente trabaja.",
    ...
    workspaceConflict: {
      ...
      copyInspectCommand: "Copiar comando de inspección en la nube",
      copyTakeCommand: "Copiar comando take-cloud",
      commandHelp:
        "Ejecuta estos comandos en Bash o zsh (Git Bash en Windows). Si la inspección indica que la ruta no existe, la nube la eliminó; verifica y elimina la ruta local manualmente. Si el checkout informa un conflicto de archivo/directorio, mueve o elimina la ruta local que lo bloquea y vuelve a intentarlo. Si falta la referencia preparada, el aviso está desactualizado; no cambies la ruta local.",
      commandsUnavailable:
        "Este nombre de archivo contiene caracteres de control de terminal, por lo que OpenClaw no generará un comando de shell copiable para él. Inspecciona la referencia preparada directamente e introduce la ruta manualmente con cuidado.",
      ...
      eventDescription:
        "Se conservaron las versiones locales de estas rutas; se aplicaron otros cambios de la nube.",
    },
    compaction: {
    ...
    messages: {
      ...
      rewindUnavailable: "Retroceder no está disponible mientras el agente está trabajando",
    ...
    observer: {
      ...
      running: "En ejecución",
      checksPassing: "{count} aprobadas",
      checksFailing: "{count} fallidas",
      checksPending: "{count} en ejecución",
      askLabel: "Preguntar sobre esta sesión",
      askPlaceholder: "¿Por qué hace eso?",
      askSubmit: "Preguntar",
      askPending: "Revisando las observaciones…",
      askBusy: "El observador ya está respondiendo una pregunta.",
      askUnavailable: "El observador no puede responder en este momento.",
    ...
    composer: {
      ...
      cameraInput: "Cámara",
      cameraListUnsupported: "Este navegador no puede enumerar cámaras.",
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del redactor, habla y luego suéltalo para insertar el texto sin enviarlo.",
    ...
    sessionDiscussion: {
      ...
      opening: "Abriendo discusión…",
      requiresWriteAccess: "Se requiere acceso de escritura de operador para abrir esta discusión.",
      openExternal: "Abrir discusión en una pestaña nueva",
      frameTitle: "Discusión de la sesión",
      unavailable: "Esta discusión no se puede incrustar.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      repeatStream: "Fuente del stream",
      onExitHelp:
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Esta carga útil se creó fuera de Control UI. Su contenido permanece de solo lectura y se conserva cuando guardas otros cambios.",
