...
export const fr: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Examinez les personnes en attente pour envoyer des messages directs aux canaux protégés par appairage.",
      channelFilter: "Canal",
      ...
      dismissAria: "Rejeter {sender} pour {channel}, compte {account}",
      ...
      noAccounts: "Aucun compte de canal configuré n'utilise l'appairage des expéditeurs de MP.",
      ...
      approveDialogTitle: "Approuver l'accès aux messages directs",
      dismissDialogTitle: "Rejeter la demande d'accès aux messages directs",
      approveExplanation:
        "Cela permet à l'expéditeur de communiquer avec l'agent en messages directs. Cela n'accorde pas l'accès aux groupes.",
      dismissExplanation:
        "Cela supprime la demande actuelle mais ne bloque pas l'expéditeur. Il pourra demander à nouveau l'accès plus tard.",
      notifyRequester: "Notifier le demandeur après l'approbation",
      makeCommandOwner: "Faire aussi de cet expéditeur le premier propriétaire de commandes",
      commandOwnerHelp:
      ...
      approvedNotice: "Accès aux messages directs approuvé.",
      approvedOwnerNotice:
        "Accès aux messages directs approuvé et le premier propriétaire de commandes a été configuré.",
      approvedNotificationFailedNotice:
        "Accès aux messages directs approuvé, mais la notification au demandeur n'a pas pu être délivrée.",
      approvedOwnerFailedNotice:
        "Accès aux messages directs approuvé, mais le premier propriétaire de commandes n'a pas pu être configuré.",
      approvedFollowupsFailedNotice:
        "Accès aux messages directs approuvé, mais la notification au demandeur et la configuration du propriétaire de commandes ont toutes deux échoué.",
      dismissedNotice:
        "Demande d'accès aux messages directs rejetée. L'expéditeur peut demander à nouveau l'accès.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Aucune session WhatsApp enregistrée n'a été supprimée. Elle est peut-être déjà absente, ou son répertoire d'authentification nécessite un nettoyage manuel.",
    },
  ...
  sessionsView: {
    ...
    deleteAllArchived: "Supprimer tous les archivés…",
    ...
    cloudWorkerPlacementConflict: "Worker cloud : {state} · 1 conflit d'espace de travail",
    cloudWorkerPlacementConflicts: "Worker cloud : {state} · {count} conflits d'espace de travail",
    cloudWorkerDescendantConflict: "Enfant du worker cloud : 1 conflit d'espace de travail",
    cloudWorkerDescendantConflicts:
      "Enfants du worker cloud : {count} conflits d'espace de travail",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      disabled: "Désactivé",
      toggleNote: "Mettre à jour l'observateur de sessions Control UI",
  ...
  subtitles: {
    ...
    labs: "Fonctionnalités expérimentales d'agents et d'outils.",
  ...
  custodian: {
    ...
    connectionChanged:
      "La connexion au Gateway a changé. Réessayez pour continuer cette configuration.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "La mise en forme ou les commentaires ont changé sans modification visible du chemin de configuration.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "paramètres",
        cli: "CLI",
        pluginInstall: "installation de plugin",
        manualEdit: "modification manuelle",
        unknown: "inconnu",
      },
    },
    nudge: {
      configReload: "Rechargement de la configuration interrompu — demandez-moi ce qui s'est passé",
  ...
  appsPage: {
    ...
    pairDevice: "Associez votre appareil",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie de journal tronquée ; affichage du dernier bloc.",
  ...
  board: {
    ...
    emptyHint: "Votre agent peut épingler des widgets ici — essayez de demander une carte d'état.",
    ...
    widget: {
      ...
      retry: "Réessayer",
      frameResolverMissing: "Le contenu du widget n'est pas disponible.",
      sandboxUnavailable: "L'hôte du bac à sable du widget n'est pas disponible.",
      ...
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Chargement du widget de plugin…",
  ...
  workboard: {
    ...
    dashboardEmpty:
      "Aucun tableau de bord pour l'instant — l'agent en activité peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Redimensionner l'ancrage du chat",
      reopenChat: "Afficher le chat",
      workboardCard: "Carte du tableau de travail : {title}, {status}",
    ...
    workspaceConflict: {
      ...
      commandHelp:
        "Exécutez ces commandes dans Bash ou zsh (Git Bash sous Windows). Si l'inspection indique que le chemin n'existe pas, le cloud l'a supprimé ; vérifiez et supprimez le chemin local manuellement. Si le checkout signale un conflit fichier/répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la référence indexée est manquante, l'avis est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
        "Ce nom de fichier contient des caractères de contrôle de terminal, donc OpenClaw ne créera pas de commande shell copiable pour celui-ci. Inspectez directement la référence indexée et saisissez le chemin manuellement avec précaution.",
    ...
    messages: {
      ...
      rewind: "Rembobiner",
      rewindConfirm: "Rembobiner jusqu'avant ce message ?",
      rewindToHere: "Rembobiner jusqu'ici",
      rewindUnavailable: "Le rembobinage n'est pas disponible pendant que l'agent travaille",
      forkUnavailable: "La bifurcation n'est pas disponible pendant que l'agent travaille",
    ...
    observer: {
      ...
      boardCurrentStatus: "État actuel",
      boardTimeline: "Chronologie de santé",
      boardCurrentRun: "Exécution en cours",
      ...
      health: {
        ...
        grinding: "En cours de travail",
        stuck: "Bloqué",
        "waiting-on-user": "En attente de vous",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone de la zone de composition, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée est indisponible. Choisissez une autre caméra ou l'option par défaut du système.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Ce widget doit être rendu à nouveau pour être exporté sous forme d'image.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Cette charge utile a été créée en dehors de Control UI. Son contenu reste en lecture seule et est préservé lorsque vous enregistrez d'autres modifications.",
