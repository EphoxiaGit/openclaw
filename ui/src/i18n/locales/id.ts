...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Tinjau orang yang menunggu untuk mengirim pesan langsung ke saluran yang dilindungi pemasangan.",
      ...
      dismissAria: "Tutup {sender} untuk {channel}, akun {account}",
      ...
      noAccounts: "Tidak ada akun saluran terkonfigurasi yang menggunakan pemasangan pengirim DM.",
      ...
      limits:
        "Permintaan kedaluwarsa setelah {minutes} menit. Setiap akun saluran dapat menyimpan hingga {count} permintaan tertunda.",
      detailTitle: "Akses DM",
      detailSubtitle: "Orang harus disetujui sebelum pesan langsung mereka sampai ke agen.",
      ...
      dismissDialogTitle: "Tolak permintaan akses DM",
      approveExplanation:
        "Ini memungkinkan pengirim berbicara dengan agen melalui pesan langsung. Ini tidak memberikan akses grup.",
      dismissExplanation:
        "Ini menghapus permintaan saat ini tetapi tidak memblokir pengirim. Mereka dapat meminta akses lagi nanti.",
      notifyRequester: "Beri tahu pemohon setelah persetujuan",
      makeCommandOwner: "Jadikan juga pengirim ini sebagai command owner pertama",
      commandOwnerHelp:
        "Command owner dapat menjalankan perintah istimewa dan menyetujui tindakan berbahaya. Opsi ini hanya tersedia saat belum ada owner yang dikonfigurasi.",
      commandOwnerNeedsAdmin:
        "Tidak ada command owner yang dikonfigurasi. Koneksi ini memerlukan operator.admin untuk menetapkan owner pertama.",
      approvedNotice: "Akses DM disetujui.",
      approvedOwnerNotice: "Akses DM disetujui dan command owner pertama telah dikonfigurasi.",
      ...
      approvedOwnerFailedNotice:
        "Akses DM disetujui, tetapi command owner pertama tidak dapat dikonfigurasi.",
      approvedFollowupsFailedNotice:
        "Akses DM disetujui, tetapi notifikasi pemohon dan penyiapan command owner sama-sama gagal.",
      dismissedNotice: "Permintaan akses DM ditolak. Pengirim dapat meminta akses lagi.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dibersihkan. Sesi mungkin sudah tidak ada, atau direktori autentikasinya perlu dibersihkan secara manual.",
    },
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Tidak dapat memverifikasi Git untuk folder ini. Pilih lagi untuk mencoba ulang.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Tampilkan aktivitas agen langsung di sidebar",
      liveActivityHint:
    ...
    sessionObserver: {
      ...
      resolvedModel: "Model kecil yang teratasi",
      modelAuto: "otomatis ({model})",
      ...
      auto: "Otomatis (bawaan penyedia)",
      disabled: "Dinonaktifkan",
      toggleNote: "Perbarui pengamat sesi Control UI",
      modelNote: "Perbarui model utilitas bawaan",
    },
    connection: {
      title: "Koneksi",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    advanced: "Setiap bagian konfigurasi lainnya, plus editor file mentah.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Muat ulang konfigurasi terhenti — tanyakan apa yang terjadi",
      ...
      channelDegraded: "{channel} sedang menurun — tanyakan apa yang terjadi",
      channelFallback: "Sebuah channel",
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan langsung tersimpan dan berlaku untuk proses agen berikutnya.",
    ...
    swarm: {
      title: "Swarm",
      description: "Biarkan Code Mode mengatur kelompok subagen secara paralel.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikasi pendamping untuk ponsel, jam tangan, desktop, dan peramban Anda — plus plugin untuk memperluas kemampuan agen Anda.",
    ...
    sectionBrowser: "Di peramban Anda",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Pendamping bilah menu untuk Gateway Anda — notifikasi, persetujuan, chat cepat.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "Perluas OpenClaw dengan channel, tool, dan Skills dari komunitas.",
      },
    },
  },
  presence: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Ikuti otomatis",
    file: "Berkas: {file}",
    truncated: "Output log dipotong; menampilkan potongan terbaru.",
  ...
  board: {
    ...
    emptyTitle: "Papan kosong, siap digunakan",
    ...
    widget: {
      ...
      rejectedDetail: "Widget ini tetap nonaktif sampai dihapus atau diganti.",
  ...
  workboard: {
    widget: {
      ...
      noActiveCards: "Tidak ada kartu yang siap atau berjalan.",
    },
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Peralihan branch tidak tersedia saat agen sedang bekerja.",
      branchSwitchRequiresAdmin: "Peralihan branch memerlukan akses admin operator.",
      untitledBranch: "Branch tanpa judul",
      oneMessage: "{count} pesan",
      messages: "{count} pesan",
      activeBranch: "Branch aktif",
    },
    board: {
      faceLabel: "Tampilan thread",
      chatFace: "Chat",
      dashboardFace: "Dasbor",
      dockMenu: "Dock chat: {dock}",
      dockLeft: "Dock chat kiri",
      dockRight: "Dock chat kanan",
      dockBottom: "Dock chat bawah",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw menyimpan versi lokal Anda dan menerapkan perubahan cloud lainnya. Periksa hasil yang di-stage atau ambil versinya untuk path yang berkonflik.",
      ...
      commandHelp:
        "Jalankan ini di Bash atau zsh (Git Bash di Windows). Jika inspect menyatakan path tidak ada, cloud telah menghapusnya; verifikasi dan hapus path lokal secara manual. Jika checkout melaporkan konflik file/direktori, pindahkan atau hapus path lokal yang menghalangi, lalu coba lagi. Jika ref yang di-stage hilang, notifikasi sudah usang; jangan ubah path lokal.",
      commandsUnavailable:
        "Nama file ini berisi karakter kontrol terminal, sehingga OpenClaw tidak akan membuat perintah shell yang dapat disalin untuknya. Periksa ref yang di-stage secara langsung dan masukkan path secara manual dengan hati-hati.",
      dismiss: "Tutup notifikasi konflik workspace",
    ...
    messages: {
      ...
      rewindUnavailable: "Mundur tidak tersedia saat agen sedang bekerja",
    ...
    observer: {
      ...
      askLabel: "Tanyakan tentang sesi ini",
      askPlaceholder: "Mengapa melakukan itu?",
      askSubmit: "Tanya",
      askPending: "Memeriksa pengamatan…",
      askBusy: "Pengamat sedang menjawab pertanyaan.",
      askUnavailable: "Pengamat tidak dapat menjawab saat ini.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon di composer, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
