...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      title: "DM 액세스 요청",
      subtitle: "페어링으로 보호된 채널에 직접 메시지를 보내려고 대기 중인 사람을 검토합니다.",
      channelFilter: "채널",
      accountFilter: "계정",
      allChannels: "모든 채널",
      allAccounts: "모든 계정",
      approve: "승인",
      dismiss: "무시",
      approveAria: "{channel} 채널, {account} 계정에 대해 {sender} 승인",
      dismissAria: "{channel} 채널, {account} 계정에 대해 {sender} 무시",
      requested: "{ago} 요청됨",
      expires: "{ago} 만료됨",
      senderDetails: "보낸 사람 세부 정보",
      missingPermission:
        "이 연결에는 operator.pairing 액세스 권한이 없으므로 DM 요청을 검토할 수 없습니다.",
      noAccounts: "DM 보낸 사람 페어링을 사용하는 구성된 채널 계정이 없습니다.",
      noRequests: "대기 중인 DM 액세스 요청이 없습니다.",
      noFilteredRequests: "이 필터와 일치하는 대기 중인 요청이 없습니다.",
      limits:
        "요청은 {minutes}분 후에 만료됩니다. 각 채널 계정은 최대 {count}개의 대기 중인 요청을 보관할 수 있습니다.",
      detailTitle: "DM 액세스",
      detailSubtitle: "다이렉트 메시지가 에이전트에 전달되기 전에 사용자를 승인해야 합니다.",
      pendingCount: "{count}건 대기 중",
      noPending: "대기 중인 요청 없음",
      review: "요청 검토",
      approveDialogTitle: "DM 액세스 승인",
      dismissDialogTitle: "DM 액세스 요청 해제",
      approveExplanation:
        "이렇게 하면 발신자가 다이렉트 메시지로 에이전트와 대화할 수 있습니다. 그룹 액세스 권한은 부여되지 않습니다.",
      dismissExplanation:
        "현재 요청을 제거하지만 발신자를 차단하지는 않습니다. 발신자는 나중에 다시 액세스를 요청할 수 있습니다.",
      notifyRequester: "승인 후 요청자에게 알림",
      makeCommandOwner: "이 발신자를 첫 번째 명령 소유자로 지정",
      commandOwnerHelp:
      ...
      approvedNotificationFailedNotice:
        "DM 액세스가 승인되었지만 요청자 알림을 전달할 수 없었습니다.",
      approvedOwnerFailedNotice:
        "DM 액세스가 승인되었지만 첫 번째 명령 소유자를 구성할 수 없었습니다.",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "클라우드 워커에는 OpenClaw 런타임이 필요하지만 {runtime}이(가) 선택되어 있습니다.",
    ...
    gitCheckUnavailable: "이 폴더에 대한 Git을 확인할 수 없습니다. 다시 선택하여 재시도하세요.",
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개 스레드 보관됨",
    deleteAllArchived: "보관된 항목 모두 삭제…",
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 해당 기록을 삭제할까요?",
  ...
  configView: {
    ...
    syncedHint: "Gateway를 통해 여러 기기에 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
    ...
    sessionObserver: {
      title: "세션 관찰자",
      hint: "소규모 유틸리티 모델로 장시간 실행되는 세션을 요약합니다.",
      toggle: "세션 관찰자",
      toggleHint: "구독된 Control UI 세션에 대한 실시간 상태 요약을 생성합니다.",
      resolvedModel: "확정된 소규모 모델",
      modelAuto: "자동 ({model})",
      modelConfigured: "구성됨 ({model})",
      modelDisabled: "비활성화됨",
      modelUnavailable: "사용 불가 (소규모 모델 없음)",
      modelPicker: "소규모 모델",
      modelPickerHint: "관찰자 요약 및 기타 짧은 유틸리티 작업에 사용됩니다.",
      modelCatalogUnavailable: "명시적 모델 카탈로그 사용 불가",
      auto: "자동 (공급자 기본값)",
      disabled: "비활성화됨",
  ...
  subtitles: {
    ...
    notifications: "게이트웨이에서 오는 브라우저 푸시 알림.",
    security: "Gateway 인증, 실행 정책, 도구 프로필, 승인.",
    advanced: "남아 있는 모든 구성 섹션과 원시 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange: "표시되는 구성 경로 변경 없이 형식이나 주석이 변경되었습니다.",
      sources: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel}이(가) 저하되었습니다 — 무슨 일이 있었는지 물어보세요",
      channelFallback: "채널",
      dismiss: "이 업데이트 닫기",
    },
  },
  mcpServers: {
    ...
    nameInvalid: "서버 이름은 문자, 숫자, 점, 대시 또는 밑줄을 사용합니다.",
    targetInvalid: "HTTP 전송에는 URL을, stdio에는 유효한 명령줄을 입력하세요.",
  ...
  labsPage: {
    intro: "Labs에는 릴리스마다 변경, 중단 또는 제거될 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 격리된 컴팩트한 JavaScript 워크플로에서 도구를 결합할 수 있게 합니다.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "완전한 OpenClaw 노드로서의 Android 휴대폰 — 채팅, 카메라, Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway용 메뉴 바 컴패니언 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "커뮤니티에서 제공하는 채널, 도구, Skills로 OpenClaw를 확장하세요.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    actionInProgress: "다른 대시보드 변경 사항이 아직 저장되고 있습니다.",
    announcement: {
    ...
    widget: {
      ...
      appLoading: "앱 복원 중…",
      appStaleTitle: "고정된 이 앱이 오래되었습니다",
      ...
      sandboxOriginRequired:
        "반복된 새로 고침 시도 후에도 위젯 인증에 실패했습니다. gateway가 위젯 샌드박스 포트를 라우팅하지 않는 리버스 프록시나 터널 뒤에서 실행되는 경우, mcp.apps.sandboxOrigin을 샌드박스 리스너로 라우팅되는 전용 공용 오리진으로 설정하세요.",
      errorTitle: "이 위젯을 로드할 수 없습니다",
      errorDetail: "이 문제는 이 카드에만 국한됩니다.",
  ...
  workboard: {
    widget: {
      cardLabel: "Workboard 카드",
      summaryLabel: "Workboard 요약",
      loading: "Workboard 로드 중…",
      cardIdRequired: "이 위젯에는 cardId 속성이 필요합니다.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "복사됨",
      branches: "스레드 브랜치",
      branchSwitchUnavailable: "에이전트가 작업 중인 동안에는 브랜치를 전환할 수 없습니다.",
      branchSwitchRequiresAdmin: "브랜치 전환에는 운영자 관리자 권한이 필요합니다.",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw가 로컬 버전을 유지하고 다른 클라우드 변경 사항을 적용했습니다. 스테이징된 결과를 검사하거나 충돌 경로에 대해 클라우드 버전을 가져오세요.",
      ...
      copyTakeCommand: "클라우드 가져오기 명령 복사",
      commandHelp:
        "이 명령들을 Bash 또는 zsh(Windows에서는 Git Bash)에서 실행하세요. 검사 결과 경로가 존재하지 않는다고 나오면 클라우드에서 삭제된 것이므로, 확인 후 로컬 경로를 수동으로 제거하세요. 체크아웃 시 파일/디렉터리 충돌이 보고되면 방해가 되는 로컬 경로를 이동하거나 제거한 뒤 다시 시도하세요. 스테이징된 ref가 없으면 알림이 오래된 것이므로 로컬 경로를 변경하지 마세요.",
      commandsUnavailable:
      ...
      eventDescription:
        "이 경로에 대해서는 로컬 버전이 유지되었습니다. 다른 클라우드 변경 사항은 적용되었습니다.",
    },
    compaction: {
      label: "압축된 기록",
    ...
    messages: {
      ...
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨기시겠습니까? 에이전트에게는 여전히 표시됩니다.",
      hideMessage: "메시지 숨기기",
    ...
    observer: {
      ...
      boardUnknownRun: "미확인 실행",
      boardSinceYouLeft: "떠난 이후",
      health: {
        "on-track": "정상 진행 중",
        grinding: "작업 중",
        stuck: "멈춤",
        "waiting-on-user": "사용자 대기 중",
        "wrapping-up": "마무리 중",
        done: "완료",
        failed: "실패",
      },
    ...
    composer: {
      ...
      offlineHint: "오프라인 — 메시지는 대기열에 저장되었다가 연결이 복구되면 전송됩니다.",
      ...
      holdToRecordSettingDescription:
        "작성 창의 마이크 버튼을 누른 채로 말한 다음 손을 떼면 전송하지 않고 텍스트가 삽입됩니다.",
      ...
      dictationReleaseToInsert: "받아쓴 내용을 삽입하려면 놓으세요",
      ...
      selectedCameraUnavailable:
        "선택한 카메라를 사용할 수 없습니다. 다른 카메라나 시스템 기본값을 선택하세요.",
