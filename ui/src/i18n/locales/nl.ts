...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Beoordeel personen die wachten om directe berichten te sturen naar kanalen die met pairing zijn beveiligd.",
      ...
      senderDetails: "Gegevens van afzender",
      missingPermission:
        "Deze verbinding heeft geen operator.pairing-toegang, dus DM-verzoeken kunnen niet worden beoordeeld.",
      noAccounts: "Geen geconfigureerde kanaalaccounts gebruiken pairing van DM-afzenders.",
      ...
      review: "Verzoeken bekijken",
      approveDialogTitle: "DM-toegang goedkeuren",
      dismissDialogTitle: "Verzoek om DM-toegang negeren",
      approveExplanation:
        "Hiermee kan de afzender via directe berichten met de agent praten. Dit verleent geen toegang tot groepen.",
      dismissExplanation:
        "Hiermee wordt het huidige verzoek verwijderd, maar de afzender wordt niet geblokkeerd. Die kan later opnieuw toegang aanvragen.",
      notifyRequester: "De aanvrager na goedkeuring op de hoogte stellen",
      makeCommandOwner: "Deze afzender ook de eerste commando-eigenaar maken",
      commandOwnerHelp:
        "Commando-eigenaren kunnen bevoorrechte commando's uitvoeren en gevaarlijke acties goedkeuren. Deze optie is alleen beschikbaar zolang er geen eigenaar is geconfigureerd.",
      commandOwnerNeedsAdmin:
        "Er is geen commando-eigenaar geconfigureerd. Deze verbinding heeft operator.admin nodig om de eerste eigenaar toe te wijzen.",
      approvedNotice: "DM-toegang goedgekeurd.",
      approvedOwnerNotice:
        "DM-toegang goedgekeurd en de eerste commando-eigenaar is geconfigureerd.",
      approvedNotificationFailedNotice:
        "DM-toegang goedgekeurd, maar de melding aan de aanvrager kon niet worden bezorgd.",
      approvedOwnerFailedNotice:
        "DM-toegang goedgekeurd, maar de eerste commando-eigenaar kon niet worden geconfigureerd.",
      approvedFollowupsFailedNotice:
        "DM-toegang goedgekeurd, maar zowel de melding aan de aanvrager als het instellen van de commando-eigenaar is mislukt.",
      dismissedNotice:
        "Verzoek om DM-toegang genegeerd. De afzender kan opnieuw toegang aanvragen.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      loggedOut: "Uitgelogd.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de auth-map vereist mogelijk handmatige opschoning.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Offline — Instellingen openen",
  ...
  newSession: {
    ...
    gitCheckUnavailable:
      "Kan Git voor deze map niet verifiëren. Kies deze opnieuw om het nogmaals te proberen.",
  ...
  sessionsView: {
    ...
    runFailedReason: "Run mislukt: {reason}",
    ...
    cloudWorkerPlacementConflict: "Cloud worker: {state} · 1 werkruimteconflict",
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} werkruimteconflicten",
    cloudWorkerDescendantConflict: "Child van cloud worker: 1 werkruimteconflict",
    cloudWorkerDescendantConflicts: "Children van cloud worker: {count} werkruimteconflicten",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "Verwerken…",
      profileHint:
        "JPEG, PNG of WebP. Afbeeldingen worden gecentreerd bijgesneden en verkleind naar 512px.",
      profileLoadFailed: "Je profiel kan niet worden geladen.",
      profileSaveFailed: "Je profiel kan niet worden opgeslagen.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Zijbalk",
      hint: "Kies wat wordt weergegeven terwijl sessies actief zijn.",
      liveActivity: "Live agentactiviteit in zijbalk weergeven",
      liveActivityHint: "Geef de nieuwste assistent- of toolactiviteit weer onder actieve sessies.",
    },
    sessionObserver: {
      title: "Sessieobservator",
      hint: "Vat langdurige sessies samen met een klein utility-model.",
      ...
      modelPickerHint: "Wordt gebruikt voor observatoroverzichten en andere korte utility-taken.",
      modelCatalogUnavailable: "Expliciete modelcatalogus niet beschikbaar",
      auto: "Automatisch (providerstandaard)",
      disabled: "Uitgeschakeld",
      toggleNote: "Werk de Control UI-sessieobservator bij",
      modelNote: "Werk het standaard utility-model bij",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Andere openstaande aanvragen",
  ...
  subtitles: {
    ...
    security: "Gateway-authenticatie, uitvoeringsbeleid, toolprofiel en goedkeuringen.",
    advanced: "Alle resterende configuratiesecties, plus de editor voor het onbewerkte bestand.",
  ...
  custodian: {
    ...
    unsupportedGateway: "Werk de Gateway bij om door te gaan met de configuratie met OpenClaw.",
    history: {
      button: "Geschiedenis",
      ...
      opaqueChange:
        "Opmaak of opmerkingen zijn gewijzigd zonder zichtbare wijzigingen in configuratiepaden.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "instellingen",
        cli: "CLI",
        pluginInstall: "plugininstallatie",
    ...
    nudge: {
      ...
      channelAuth: "{channel}-authenticatie is verslechterd — vraag me wat er is gebeurd",
  ...
  mcpServers: {
    ...
    targetInvalid: "Voer een URL in voor HTTP-transports of een geldige opdrachtregel voor stdio.",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen wijzigen, defect kunnen raken of kunnen verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden onmiddellijk opgeslagen en zijn van toepassing op toekomstige agentuitvoeringen.",
    ...
    codeMode: {
      title: "Code Mode",
      description: "Laat agents tools combineren in compacte, gesandboxte JavaScript-workflows.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    ctaSetupGuide: "Installatiehandleiding",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, praat, keur acties goed en deel naar OpenClaw vanuit iOS.",
      },
      android: {
        title: "Android",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG of WebP. Afbeeldingen worden verkleind tot 256 × 256 of kleiner.",
      chooseAvatar: "Afbeelding kiezen",
      processingAvatar: "Verwerken…",
      displayName: "Weergavenaam",
      displayNameDescription: "Wordt getoond aan andere mensen die deze gateway gebruiken.",
      linkedEmails: "Gekoppelde e-mailadressen",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer afgekapt; nieuwste gedeelte wordt getoond.",
  ...
  board: {
    ...
    emptyHint: "Je agent kan hier widgets vastpinnen — probeer te vragen om een statuskaart.",
    ...
    announcement: {
      ...
      resized: "{title} van grootte gewijzigd.",
    ...
    widget: {
      cellLabel:
        "Dashboardwidget: {title}. Gebruik de pijltoetsen om te navigeren. Houd Alt ingedrukt en druk op een pijltoets om deze te verplaatsen.",
      moveHandle: "{title} verplaatsen",
      resizeHandle: "Grootte van {title} wijzigen",
      ...
      needsApprovalDetail: "Deze widget heeft om extra toegang gevraagd.",
      ...
      sandboxOriginRequired:
        "Widgetautorisatie is mislukt na herhaalde vernieuwingspogingen. Als de gateway achter een reverse proxy of tunnel draait die de widget-sandboxpoort niet routeert, stel mcp.apps.sandboxOrigin dan in op een specifieke openbare oorsprong die naar de sandboxlistener wordt gerouteerd.",
      errorTitle: "Deze widget kan niet worden geladen",
  ...
  workboard: {
    widget: {
      ...
      noActiveCards: "Geen kaarten die klaar zijn of worden uitgevoerd.",
    },
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Gekopieerd",
      branches: "Thread-vertakkingen",
      branchSwitchUnavailable:
        "Wisselen van vertakking is niet beschikbaar terwijl de agent bezig is.",
      branchSwitchRequiresAdmin:
        "Wisselen van vertakking vereist beheerdersrechten voor operators.",
    ...
    board: {
      ...
      workboardCard: "Workboardkaart: {title}, {status}",
      defaultTab: "Hoofd",
      mockPlaceholder: "Boardweergavenaad · {tabs} tabbladen · {widgets} widgets",
    ...
    workspaceConflict: {
      titleOne: "1 cloudwerkruimteconflict",
      titleMany: "{count} cloudwerkruimteconflicten",
      description:
        "OpenClaw heeft je lokale versies behouden en de andere cloudwijzigingen toegepast. Controleer het gestagede resultaat of neem de versie ervan over voor een conflicterend pad.",
      morePaths: "+{count} extra paden",
      stagedResult: "Gestaged cloudresultaat",
      copyStagedResult: "Referentie van gestaged resultaat kopiëren",
      inspectCloud: "De eerste cloudversie inspecteren",
      takeCloud: "De eerste cloudversie overnemen",
      copyInspectCommand: "Cloud-inspectieopdracht kopiëren",
      copyTakeCommand: "take-cloud-opdracht kopiëren",
      commandHelp:
        "Voer deze uit in Bash of zsh (Git Bash op Windows). Als inspect meldt dat het pad niet bestaat, heeft de cloud het verwijderd; controleer dit en verwijder het lokale pad handmatig. Als checkout een bestands-/mapconflict meldt, verplaats of verwijder dan het blokkerende lokale pad en probeer het opnieuw. Als de gestagede ref ontbreekt, is de melding verouderd; wijzig het lokale pad niet.",
      commandsUnavailable:
        "Deze bestandsnaam bevat terminalbesturingstekens, dus OpenClaw maakt er geen kopieerbare shellopdracht voor. Inspecteer de gestagede ref rechtstreeks en voer het pad zorgvuldig handmatig in.",
      dismiss: "Melding over workspace-conflict sluiten",
      eventSender: "Cloudworkspace",
    ...
    messages: {
      ...
      reply: "Antwoorden",
      replyToMessage: "Op bericht antwoorden",
      rewind: "Terugspoelen",
    ...
    observer: {
      ...
      hide: "Sessiewaarnemer verbergen",
      show: "Sessiewaarnemer weergeven",
      plan: "Plan",
      ...
      boardUnknownRun: "Onbekende run",
      boardSinceYouLeft: "Sinds je weg bent",
      health: {
        "on-track": "Op schema",
        grinding: "Bezig",
        stuck: "Vastgelopen",
        "waiting-on-user": "Wachten op jou",
    ...
    composer: {
      ...
      offlineHint:
        "Offline — berichten worden in de wachtrij geplaatst en verzonden zodra de verbinding terug is.",
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop in de composer ingedrukt, spreek en laat vervolgens los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported:
        "De Gateway heeft een niet-ondersteund audioformaat voor dicteren geretourneerd.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dictatieaudio opnemen op 8 kHz.",
      dictationConnecting: "Dicteren starten…",
      dictationDisconnected: "Dicteren is gestopt omdat de Gateway de verbinding heeft verbroken.",
      dictationFailed: "Dicteren is mislukt.",
      dictationFinalizing: "Dicteren afronden…",
      dictationFinalizationTimedOut:
        "Dicteren is gestopt voordat het laatste gedeeltelijke transcript kon worden afgerond.",
      ...
      dictationReleaseToInsert: "Laat los om dicteren in te voegen",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Deze widget moet opnieuw worden gerenderd om als afbeelding te exporteren.",
      widgetExportFailed: "Exporteren van widget mislukt. Probeer het opnieuw.",
    ...
    sessionDiscussion: {
      title: "Discussie",
      show: "Discussie weergeven",
      disconnected: "Gateway is niet verbonden.",
      loading: "Discussie laden…",
      opening: "Discussie openen…",
      requiresWriteAccess: "Schrijftoegang als operator is vereist om deze discussie te openen.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Deze payload is buiten Control UI gemaakt. De inhoud blijft alleen-lezen en wordt bewaard wanneer u andere wijzigingen opslaat.",
