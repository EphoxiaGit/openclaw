...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      title: "Prośby o dostęp do wiadomości prywatnych",
      subtitle:
        "Przejrzyj osoby oczekujące na możliwość wysyłania wiadomości prywatnych do kanałów chronionych parowaniem.",
      channelFilter: "Kanał",
      accountFilter: "Konto",
      ...
      requested: "Zażądano {ago}",
      expires: "Wygasa {ago}",
      senderDetails: "Szczegóły nadawcy",
      missingPermission:
        "To połączenie nie ma dostępu operator.pairing, więc nie można przeglądać próśb o wiadomości prywatne.",
      noAccounts:
        "Żadne skonfigurowane konta kanałów nie używają parowania nadawców wiadomości prywatnych.",
      noRequests: "Brak oczekujących próśb o dostęp do wiadomości prywatnych.",
      noFilteredRequests: "Żadne oczekujące prośby nie pasują do tych filtrów.",
      limits:
        "Prośby wygasają po {minutes} minutach. Każde konto kanału może przechowywać maksymalnie {count} oczekujących próśb.",
      detailTitle: "Dostęp do wiadomości prywatnych",
      detailSubtitle:
      ...
      makeCommandOwner: "Ustaw też tego nadawcę jako pierwszego właściciela poleceń",
      commandOwnerHelp:
      ...
      commandOwnerNeedsAdmin:
        "Nie skonfigurowano właściciela poleceń. To połączenie wymaga operator.admin, aby przypisać pierwszego właściciela.",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie usunięto żadnej zapisanej sesji WhatsApp. Może już nie istnieć albo jej katalog uwierzytelniania wymaga ręcznego wyczyszczenia.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Procesy w chmurze wymagają środowiska uruchomieniowego OpenClaw; wybrano {runtime}.",
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "Worker w chmurze: {state} · 1 konflikt obszaru roboczego",
    cloudWorkerPlacementConflicts:
      "Worker w chmurze: {state} · {count} konfliktów obszaru roboczego",
    cloudWorkerDescendantConflict: "Podrzędny worker w chmurze: 1 konflikt obszaru roboczego",
    cloudWorkerDescendantConflicts:
      "Podrzędne workery w chmurze: {count} konfliktów obszaru roboczego",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane centralnie i skalowane do 512px.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co jest wyświetlane podczas działających sesji.",
  ...
  custodian: {
    ...
    connectionChanged: "Połączenie z Gateway się zmieniło. Ponów, aby kontynuować tę konfigurację.",
    sessionRestarted:
      "{error} OpenClaw rozpoczął nową sesję; wcześniejsze wiadomości pozostają dla kontekstu.",
    ...
    history: {
      ...
      requestFailed: "OpenClaw nie mógł załadować historii zmian.",
    ...
    nudge: {
      ...
      channelAuth: "Uwierzytelnianie {channel} pogorszyło się — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    targetInvalid: "Wpisz URL dla transportów HTTP lub prawidłowy wiersz poleceń dla stdio.",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Pozwól Code Mode zarządzać grupami subagentów równolegle.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Czatuj, rozmawiaj, zatwierdzaj działania i udostępniaj do OpenClaw z systemu iOS.",
      },
      android: {
        title: "Android",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw sterować Twoim istniejącym Chrome — karty, strony i formularze.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "Ładowanie Twojej tożsamości…",
  ...
  gatewayLogs: {
    title: "Dzienniki",
    subtitle: "Logi plików Gateway (JSONL).",
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Wynik logów skrócony; wyświetlana jest najnowsza część.",
  ...
  board: {
    ...
    emptyTitle: "Pusta tablica, gotowa do pracy",
    ...
    actionInProgress: "Inna zmiana panelu jest wciąż zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Zezwolono na dostęp do widżetu.",
      rejected: "Odrzucono dostęp widżetu.",
    },
    widget: {
      cellLabel:
        "Widżet pulpitu: {title}. Użyj klawiszy strzałek, aby nawigować. Przytrzymaj Alt i naciśnij klawisz strzałki, aby go przesunąć.",
      ...
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli Gateway działa za reverse proxy lub tunelem, który nie przekierowuje portu piaskownicy widżetu, ustaw mcp.apps.sandboxOrigin na dedykowany publiczny origin przekierowany do nasłuchu piaskownicy.",
      errorTitle: "Nie można załadować tego widżetu",
      errorDetail: "Problem jest ograniczony do tej karty.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Brak panelu — pracujący agent może przypinać widżety.",
    openSession: "Otwórz sesję",
  ...
  modelProviders: {
    ...
    globalUsage: "Globalne użycie i koszty",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Przygotowywanie środowiska…",
    ...
    sessionHeader: {
      ...
      untitledBranch: "Gałąź bez nazwy",
    ...
    board: {
      ...
      defaultTab: "Główny",
      mockPlaceholder: "Złącze widoku tablicy · karty: {tabs} · widżety: {widgets}",
    ...
    workspaceConflict: {
      ...
      copyTakeCommand: "Kopiuj polecenie przejęcia z chmury",
      commandHelp:
        "Uruchom je w Bash lub zsh (Git Bash w systemie Windows). Jeśli inspekcja zgłosi, że ścieżka nie istnieje, chmura ją usunęła; sprawdź i usuń lokalną ścieżkę ręcznie. Jeśli checkout zgłosi konflikt pliku/katalogu, przenieś lub usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli przygotowana referencja jest niedostępna, powiadomienie jest nieaktualne; nie zmieniaj lokalnej ścieżki.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera znaki sterujące terminala, więc OpenClaw nie zbuduje dla niej gotowego do skopiowania polecenia powłoki. Sprawdź przygotowaną referencję bezpośrednio i wprowadź ścieżkę ręcznie z zachowaniem ostrożności.",
      ...
      eventTitleMany: "Wynik z chmury zastosowany z liczbą konfliktów: {count}",
      eventDescription:
        "Dla tych ścieżek zachowano wersje lokalne; pozostałe zmiany z chmury zostały zastosowane.",
    },
    compaction: {
    ...
    messages: {
      ...
      rewindConfirm: "Przewinąć do stanu sprzed tej wiadomości?",
      rewindToHere: "Przewiń tutaj",
      rewindUnavailable: "Przewijanie jest niedostępne, gdy agent pracuje",
    ...
    modelControls: {
      ...
      reasoning: "Rozumowanie",
      speed: "Prędkość",
      sessionOverride: "Zastąpienie w wątku",
      usingDefault: "Używanie domyślnego z Ustawień",
    ...
    composer: {
      ...
      dictationBrowserAudioUnsupported:
        "Ta przeglądarka nie może przechwytywać dźwięku dyktowania w częstotliwości 8 kHz.",
      dictationConnecting: "Uruchamianie dyktowania…",
      dictationDisconnected: "Dyktowanie zatrzymano, ponieważ Gateway się rozłączył.",
      ...
      dictationProviderUnavailable: "Nie skonfigurowano dostawcy transkrypcji do dyktowania.",
