...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Analise as pessoas aguardando para enviar mensagens diretas para canais protegidos por pareamento.",
      channelFilter: "Canal",
      accountFilter: "Conta",
      ...
      noAccounts: "Nenhuma conta de canal configurada usa pareamento de remetente de DM.",
      ...
      detailSubtitle:
        "As pessoas precisam ser aprovadas antes que suas mensagens diretas cheguem ao agente.",
      pendingCount: "{count} pendente(s)",
      noPending: "Nenhuma solicitação pendente",
      review: "Analisar solicitações",
      approveDialogTitle: "Aprovar acesso a DMs",
      dismissDialogTitle: "Descartar solicitação de acesso a DMs",
      approveExplanation:
      ...
      makeCommandOwner: "Também tornar este remetente o primeiro command owner",
      commandOwnerHelp:
        "Os command owners podem executar comandos privilegiados e aprovar ações perigosas. Esta opção só está disponível enquanto nenhum owner estiver configurado.",
      commandOwnerNeedsAdmin:
        "Nenhum command owner está configurado. Esta conexão precisa de operator.admin para atribuir o primeiro owner.",
      approvedNotice: "Acesso a DMs aprovado.",
      approvedOwnerNotice: "Acesso a DMs aprovado e o primeiro command owner foi configurado.",
      approvedNotificationFailedNotice:
        "Acesso a DMs aprovado, mas a notificação ao solicitante não pôde ser entregue.",
      approvedOwnerFailedNotice:
        "Acesso a DMs aprovado, mas o primeiro command owner não pôde ser configurado.",
      approvedFollowupsFailedNotice:
        "Acesso a DMs aprovado, mas a notificação ao solicitante e a configuração do command owner falharam.",
      dismissedNotice:
        "Solicitação de acesso a DMs descartada. O remetente pode solicitar acesso novamente.",
    },
    setup: {
  ...
  sessionsView: {
    ...
    sessionState: "Estado da thread",
    all: "Todos",
    sessionArchived: "Thread arquivada",
    sessionsArchived: "{count} conversas arquivadas",
    ...
    noActiveSessions: "Nenhuma conversa ativa.",
    ...
    lastActive: "Ativa por último {time}",
    surface: "Superfície",
    subject: "Assunto",
    room: "Sala",
    space: "Espaço",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são recortadas ao centro e redimensionadas para 512px.",
      ...
      avatarTooLarge: "O avatar processado ainda é grande demais.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "As notificações são exibidas de forma nativa pelo aplicativo OpenClaw neste Mac.",
    ...
    sessionObserver: {
      ...
      toggleHint: "Gere resumos de status ao vivo para sessões do Control UI inscritas.",
      ...
      disabled: "Desativada",
      toggleNote: "Atualizar o observador de sessão do Control UI",
  ...
  nav: {
    ...
    askOpenClaw: "Pergunte ao OpenClaw",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "A formatação ou os comentários mudaram sem alterações visíveis nos caminhos de configuração.",
      sources: {
  ...
  mcpServers: {
    ...
    nameInvalid: "Os nomes de servidores usam letras, números, pontos, traços ou sublinhados.",
    targetInvalid:
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Permita que os agentes combinem ferramentas em fluxos de trabalho JavaScript compactos e isolados.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para seu telefone, relógio, desktop e navegador — além de plugins para ampliar o que seu agente pode fazer.",
    sectionMobile: "No seu telefone",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversas rápidas de olhar e respostas ágeis direto do seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "O companheiro para Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus para o seu Gateway — notificações, aprovações, chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O companheiro para Windows conecta seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Aplicativo de desktop nativo — builds .deb e AppImage.",
      },
      chrome: {
  ...
  board: {
    ...
    widget: {
      ...
      sandboxUnavailable: "O host do sandbox do widget está indisponível.",
      frameAuthorizationFailed:
        "A autorização do widget falhou após repetidas tentativas de atualização.",
      sandboxOriginRequired:
        "A autorização do widget falhou após repetidas tentativas de atualização. Se o gateway for executado atrás de um proxy reverso ou túnel que não roteia a porta do sandbox do widget, defina mcp.apps.sandboxOrigin como uma origem pública dedicada roteada para o listener do sandbox.",
  ...
  workboard: {
    widget: {
      ...
      cardIdRequired: "Este widget precisa de uma prop cardId.",
    ...
    dashboardEmpty: "Nenhum painel ainda — o agente em atividade pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Copiado",
      branches: "Ramificações da conversa",
    ...
    workspaceConflict: {
      ...
      description:
        "O OpenClaw manteve suas versões locais e aplicou as demais alterações da nuvem. Inspecione o resultado preparado ou use a versão dela para um caminho em conflito.",
      ...
      commandHelp:
        "Execute estes no Bash ou zsh (Git Bash no Windows). Se a inspeção informar que o caminho não existe, a nuvem o excluiu; verifique e remova o caminho local manualmente. Se o checkout relatar um conflito de arquivo/diretório, mova ou remova o caminho local que está bloqueando e tente novamente. Se o ref preparado estiver ausente, o aviso está desatualizado; não altere o caminho local.",
      commandsUnavailable:
        "Este nome de arquivo contém caracteres de controle de terminal, então o OpenClaw não criará um comando de shell copiável para ele. Inspecione o ref preparado diretamente e insira o caminho manualmente com cuidado.",
      ...
      eventDescription:
        "As versões locais foram mantidas para estes caminhos; outras alterações na nuvem foram aplicadas.",
    },
    compaction: {
    ...
    imageLightbox: {
      label: "Visualização da imagem: {title}",
      open: "Abrir imagem {title}",
      openOriginal: "Abrir original",
      close: "Fechar visualização da imagem",
      untitled: "Imagem",
    },
    messages: {
      activity: "Atividade",
      ...
      rewindUnavailable: "Retroceder está indisponível enquanto o agente está trabalhando",
      forkUnavailable: "Bifurcar está indisponível enquanto o agente está trabalhando",
    ...
    observer: {
      ...
      askUnavailable: "O observador não pode responder agora.",
    ...
    composer: {
      ...
      offlineHint: "Offline — as mensagens serão enfileiradas e enviadas quando a conexão voltar.",
      ...
      microphoneAppliesNextSession:
        "As alterações são aplicadas ao iniciar sua próxima sessão do Talk.",
      ...
      holdToRecordSettingDescription:
        "Segure o botão do microfone do compositor, fale e solte para inserir o texto sem enviar.",
      ...
      dictationDisconnected: "O ditado parou porque o Gateway foi desconectado.",
      dictationFailed: "Falha no ditado.",
      dictationFinalizing: "Concluindo ditado…",
      dictationFinalizationTimedOut:
        "O ditado parou antes que a última transcrição parcial pudesse ser finalizada.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Este widget precisa ser renderizado novamente para exportar como imagem.",
