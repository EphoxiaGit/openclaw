...
export const ru: TranslationMap = {
  ...
  chat: {
    ...
    inputRequest: {
      ...
      information: "Information",
      managedFileReferences: "Managed file references",
      managedFileHelp: "Comma-separated IDs for files already managed by this OpenClaw session.",
      artifactReferences: "Artifact references",
      artifactHelp: "Comma-separated IDs for artifacts already available in this conversation.",
      source: "Source",
      sourceEnvironment: "Environment",
      sourceFile: "File provider",
      sourceExec: "Exec provider",
      providerAlias: "Provider alias",
      secretLocator: "Secret locator",
    ...
    liveWork: {
      region: "Live work status",
      loading: "Loading live work…",
      live: "Активен",
      stale: "Устаревшие",
      attention: "Внимание",
      complete: "Complete",
      ...
      planAmbiguous:
        "Multiple active plans were found. Work details are read-only until one plan remains active.",
      ...
      actionPrepared: "Worktree action prepared. Review and send.",
      ...
      detail: {
        ...
        none: "Нет",
        evidence: "Evidence",
        evidenceSummary: "{count} attempt records · checkpoint {checkpoint}",
        present: "present",
        notPresent: "not present",
        revisions: "Revisions: project {project}, plan {plan}, goal {goal}, capsule {capsule}",
        nextTask: "Next task",
        current: "Current",
        unavailable: "Unavailable",
        capsule: "Capsule",
        checkpoint: "Checkpoint",
        readyStep: "Ready step",
        tabPlan: "Plan",
        tabAgents: "Агенты",
        tabChanges: "Changes",
        tabValidation: "Validation",
        tabRouting: "Routing",
        tabOrchestration: "Оркестрация",
        tabAttempts: "Attempts",
        tabContext: "Context",
        tablistLabel: "Work plan details",
        modalLabel: "Work details",
        noneRecorded: "None recorded.",
        orderedSteps: "Ordered steps",
        ...
        revisionsAndTiming: "Revisions and timing",
        revisionsExtended: "Definition {definition} · Plan {plan} · Record {record} · Goal {goal}",
        updatedAt: "Обновлено {time}",
        attempts: "Attempts",
        attemptNumber: "Attempt {number}",
        recoveryRecorded: " · recovery recorded",
        attemptTiming: "Started {started} · Updated {updated} · Ended {ended} · {duration}",
        durationMs: "{duration} ms",
        noAttempts: "No attempts recorded.",
        agents: "Agents and workers",
        noAgents: "No workers are attached to this plan.",
        workerNumber: "Worker {number}",
        workerParent: "Parent: {parent}",
        workerElapsed: "Elapsed {duration} ms",
        workerProgress: "Progress",
        workerResult: "Result",
        cancel: "Отмена",
        cancelWorker: "Cancel {worker}",
        cancelFailed: "Could not cancel this worker.",
        role: "Assigned role",
        lane: "Assigned lane",
        runtime: "Среда выполнения",
        model: "Модель",
        ...
        noRoutes: "No worker routes are attached to this plan.",
        orchestration: "Durable orchestration",
        noOrchestration: "No durable orchestration is attached to this plan.",
        orchestrationNumber: "Durable job {number}",
        pattern: "Pattern",
        patternPlannerReviewer: "Planner and reviewer",
        patternDiagnosticHandoff: "Diagnostic handoff",
        patternSequential: "Sequential",
        patternCustom: "Custom",
        phase: "Current phase",
        state: "State",
        waitReason: "Waiting for",
        waitApproval: "Approval",
        waitInput: "Ввод",
        waitOther: "External checkpoint",
        tasks: "Tasks",
        taskCounts: "{active} active / {total} total",
        failures: "Failures",
        completionDelivery: "Completion dispatch",
        deliveryDelivered: "Доставлено",
        deliveryPending: "Pending",
        deliveryFailed: "Сбой",
        deliveryNotApplicable: "Not applicable",
        notifyPolicy: "Notification policy",
        notifyDoneOnly: "Completion only",
        notifyStateChanges: "State changes",
        notifySilent: "Без уведомлений",
        result: "Latest result",
        resumeOrchestration: "Resume checkpoint",
        cancelOrchestration: "Cancel job",
        resumeOrchestrationDraft:
          'Resume durable orchestration "{job}" from its existing checkpoint. Preserve the current plan and continue the same attempt.',
        cancelOrchestrationDraft:
          'Cancel durable orchestration "{job}" through its current owner, preserving its latest checkpoint and completion record.',
        changes: "Managed worktrees and changes",
        noWorktrees: "No managed worktree is attached to this plan.",
        worktreeNumber: "Worktree {number}",
        worktreeState: "Worktree state",
        worktreeActive: "Активно",
        worktreeRestorable: "Restorable snapshot",
        commitState: "Commit state",
        commitClean: "Clean",
        commitUncommitted: "Uncommitted changes",
        commitConflicted: "Conflicts require resolution",
        commitUnpushed: "Committed locally",
        branch: "Ветка",
        baseRef: "Base",
        ...
        listTruncated: "Additional entries are omitted from this bounded view.",
        ...
        reviewDiffDraft:
          'Review the full diff for managed worktree "{worktree}" and summarize the changed behavior. Do not push or deploy.',
        prepareCommitDraft:
          'Review the diff and validation for managed worktree "{worktree}", then prepare one focused commit. Do not push or deploy.',
        resolveConflictsDraft:
          'Resolve the current repository conflicts in managed worktree "{worktree}", preserve unrelated changes, and report the result.',
        resumeWorktreeDraft:
          'Resume managed worktree "{worktree}" from its retained snapshot and report the recovered changes.',
        rollbackWorktreeDraft:
          'Roll back the uncommitted changes in managed worktree "{worktree}" only after preserving a recoverable snapshot. Do not push or deploy.',
        requestedRoute: "Requested route",
        selectedRoute: "Selected route",
        actualRoute: "Observed runtime route",
        notObserved: "Not yet observed",
        routeSource: "Route source",
        routeSourceTaskOverride: "Task override",
        routeSourceAgentPolicy: "Agent policy",
        routeSourceAutomaticFallback: "Automatic fallback",
        exactModel: "Exact-model status",
        exactMatched: "Exact match",
        exactSubstituted: "Substituted",
        exactUnverified: "Not yet verified",
        exactNotRequested: "No exact request",
        fallbackPolicy: "Fallback policy",
        fallbackDisabled: "Отключено",
        fallbackConfigured: "Настроено",
        fallbackUsed: "Used",
        fallbackReason: "Fallback reason",
        pacing: "Pacing",
        pacingStandard: "Standard",
        pacingFast: "Быстро",
        pacingAuto: "Automatic",
        quotaLane: "Quota lane",
        unknown: "Неизвестно",
        context: "Context",
        ...
        contextPresence: "Checkpoint {checkpoint} · Handoff {handoff}",
        checkpointEvidence: "Checkpoint evidence",
        validationActions: "Validation actions",
        runTests: "Test {worktree}",
        runTestsDraft:
          'Run the focused validation for managed worktree "{worktree}" and report tests, builds, lint, and blockers without changing live state.',
        files: "Файлы",
        tests: "Tests",
        blockers: "Blockers",
        countsOnly: "Counts only. Open Session Workspace to inspect available artifacts.",
        noCheckpoint: "No checkpoint is available.",
        blockerCount: "{count} blocked",
