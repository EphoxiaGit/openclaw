...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Eşleştirme korumalı kanallara doğrudan mesaj göndermeyi bekleyen kişileri inceleyin.",
      channelFilter: "Kanal",
      accountFilter: "Hesap",
      ...
      approve: "Onayla",
      dismiss: "Yoksay",
      approveAria: "{account} hesabı için {channel} kanalında {sender} onayla",
      dismissAria: "{account} hesabı için {channel} kanalında {sender} yoksay",
      requested: "İstek zamanı: {ago}",
      expires: "Sona erme: {ago}",
      senderDetails: "Gönderen ayrıntıları",
      missingPermission:
        "Bu bağlantının operator.pairing erişimi yok, bu nedenle DM istekleri incelenemez.",
      noAccounts: "Yapılandırılmış hiçbir kanal hesabı DM gönderen eşleştirmesini kullanmıyor.",
      ...
      dismissDialogTitle: "DM erişim isteğini reddet",
      approveExplanation:
        "Bu, gönderenin doğrudan mesajlarda aracıyla konuşmasını sağlar. Grup erişimi vermez.",
      dismissExplanation:
      ...
      commandOwnerHelp:
        "Komut sahipleri ayrıcalıklı komutları çalıştırabilir ve tehlikeli işlemleri onaylayabilir. Bu seçenek yalnızca hiçbir sahip yapılandırılmamışken kullanılabilir.",
      commandOwnerNeedsAdmin:
        "Yapılandırılmış bir komut sahibi yok. Bu bağlantının ilk sahibi atamak için operator.admin gerekiyor.",
      ...
      approvedFollowupsFailedNotice:
        "DM erişimi onaylandı, ancak isteği yapan bildirimi ve komut sahibi kurulumu başarısız oldu.",
      dismissedNotice: "DM erişim isteği reddedildi. Gönderen tekrar erişim isteyebilir.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten mevcut olmayabilir ya da kimlik doğrulama dizini elle temizlenmesi gerekebilir.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler ortadan kırpılır ve 512 piksele yeniden boyutlandırılır.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Sistem Ayarları > Bildirimler bölümünden bunlara izin verin.",
    },
    appearance: {
      theme: "Tema",
    ...
    sessionObserver: {
      ...
      hint: "Uzun süren oturumları küçük bir yardımcı modelle özetleyin.",
      ...
      modelConfigured: "yapılandırılmış ({model})",
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} tarafından gelen onayı inceleyin: {command}",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "Hassas değer girin…",
    ...
    history: {
      ...
      opaqueChange:
        "Görünür yapılandırma yolu değişikliği olmadan biçimlendirme veya yorumlar değişti.",
      sources: {
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yükleme durdu — bana ne olduğunu sor",
      ...
      channelDegraded: "{channel} bozulmuş durumda — bana ne olduğunu sor",
  ...
  mcpServers: {
    ...
    targetInvalid: "HTTP taşımaları için bir URL veya stdio için geçerli bir komut satırı girin.",
    ...
    addedSuccess: "MCP sunucusu {name} eklendi.",
    enabledSuccess: "MCP sunucusu {name} etkinleştirildi.",
    disabledSuccess: "MCP sunucusu {name} devre dışı bırakıldı.",
    removedSuccess: "MCP sunucusu {name} kaldırıldı.",
    configUnavailable: "Yapılandırma kullanılamıyor; yenileyin ve tekrar deneyin.",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıkla bağlanan bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Değişiklikler hemen kaydedilir ve gelecekteki agent çalıştırmalarına uygulanır.",
    documentation: "Belgeler",
    restartRequired: "Gateway yeniden başlatılması gerekiyor.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Kod Modu",
      description:
        "Aracıların araçları kompakt, izole edilmiş JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "OpenClaw'u her yere götürün",
    heroTagline:
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'ta sohbet edin, konuşun, eylemleri onaylayın ve OpenClaw'a paylaşın.",
      },
      android: {
        title: "Android",
      ...
      linux: {
        title: "Linux",
        desc: "Yerel masaüstü uygulaması — .deb ve AppImage yapıları.",
      },
      chrome: {
      ...
      plugins: {
        ...
        desc: "OpenClaw'u topluluktan gelen kanallar, araçlar ve Skills ile genişletin.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      setIdentity: "Kimlik ayarla",
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG veya WebP. Görüntüler 256 × 256 veya daha küçük boyuta getirilir.",
  ...
  board: {
    ...
    emptyTitle: "Çalışmaya hazır, temiz bir pano",
    emptyHint: "Aracınız buraya widget'lar sabitleyebilir — bir durum kartı istemeyi deneyin.",
    ...
    widget: {
      ...
      hostTools: "Ana bilgisayar araçları ve verileri",
      activeCapabilities: "Etkin widget özellikleri",
      ...
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget sandbox portunu yönlendirmeyen bir ters proxy veya tünel arkasında çalışıyorsa mcp.apps.sandboxOrigin değerini sandbox dinleyicisine yönlendirilen özel bir genel origin olarak ayarlayın.",
      ...
      kindHtml: "HTML",
      kindPlugin: "Eklenti",
      pluginLoading: "Eklenti widget'ı yükleniyor…",
      disabledPlugin: "Devre dışı eklentiden gelen widget {pluginId}",
    },
  },
  workboard: {
    widget: {
      ...
      cardIdRequired: "Bu widget bir cardId prop'una ihtiyaç duyar.",
    ...
    dashboardEmpty: "Henüz kontrol paneli yok — çalışan aracı widget'ları sabitleyebilir.",
    openSession: "Oturumu aç",
  ...
  chat: {
    ...
    outputTokens: "{count} çıktı token'ı",
    ...
    board: {
      ...
      chatFace: "Sohbet",
      dashboardFace: "Pano",
      dockMenu: "Sohbet yerleşimi: {dock}",
      dockLeft: "Sohbeti sola yerleştir",
      dockRight: "Sohbeti sağa yerleştir",
      dockBottom: "Sohbeti alta yerleştir",
      dockHidden: "Sohbeti gizle",
      resizeDock: "Sohbet yerleşimini yeniden boyutlandır",
      reopenChat: "Sohbeti göster",
      workboardCard: "İş panosu kartı: {title}, {status}",
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü birleşimi · {tabs} sekme · {widgets} bileşen",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw yerel sürümlerinizi korudu ve diğer bulut değişikliklerini uyguladı. Hazırlanan sonucu inceleyin veya çakışan bir yol için bulut sürümünü alın.",
      ...
      commandHelp:
        "Bunları Bash veya zsh (Windows'ta Git Bash) ile çalıştırın. İnceleme yolun mevcut olmadığını söylüyorsa, bulut onu sildi; doğrulayın ve yerel yolu manuel olarak kaldırın. Checkout bir dosya/dizin çakışması bildirirse, engelleyen yerel yolu taşıyın veya kaldırın, sonra tekrar deneyin. Hazırlanan referans eksikse, bildirim eskimiştir; yerel yolu değiştirmeyin.",
      commandsUnavailable:
        "Bu dosya adı terminal kontrol karakterleri içeriyor, bu nedenle OpenClaw onun için kopyalanabilir bir kabuk komutu oluşturmaz. Hazırlanan referansı doğrudan inceleyin ve yolu dikkatlice manuel olarak girin.",
    ...
    questions: {
      ...
      ownAnswer: "Kendi cevabınız…",
      ownAnswerFor: "{header} için kendi cevabınız",
    ...
    imageLightbox: {
      label: "Görsel önizleme: {title}",
      open: "Görseli aç {title}",
      openOriginal: "Orijinali aç",
      close: "Görsel önizlemeyi kapat",
      untitled: "Görsel",
    },
    messages: {
      activity: "Etkinlik",
    ...
    observer: {
      ...
      plan: "Plan",
      progress: "{total} içinden {completed}",
      pullRequests: "Pull request'ler",
      running: "Çalışıyor",
      checksPassing: "{count} başarılı",
      checksFailing: "{count} başarısız",
      checksPending: "{count} çalışıyor",
      askLabel: "Bu oturum hakkında soru sor",
      askPlaceholder: "Bunu neden yapıyor?",
      askSubmit: "Sor",
      ...
      boardCurrentStatus: "Geçerli durum",
      boardTimeline: "Sağlık zaman çizelgesi",
      boardCurrentRun: "Geçerli çalıştırma",
      boardPreviousRun: "Önceki çalıştırma",
      boardUnknownRun: "Tanımlanamayan çalıştırma",
      boardSinceYouLeft: "Siz ayrıldığınızdan beri",
      health: {
        "on-track": "Yolunda",
        grinding: "Çalışıyor",
        stuck: "Takıldı",
    ...
    composer: {
      ...
      holdToRecordSetting: "Dikte için mikrofon düğmesini basılı tutun",
      holdToRecordSettingDescription:
        "Yazma alanındaki mikrofon düğmesini basılı tutun, konuşun ve ardından metni göndermeden eklemek için bırakın.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget dışa aktarımı başarısız oldu. Tekrar deneyin.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Betik",
      readOnlyPayloadHelp:
        "Bu veri, Control UI dışında oluşturuldu. İçeriği salt okunur kalır ve diğer değişiklikleri kaydettiğinizde korunur.",
