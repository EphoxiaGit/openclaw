...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      subtitle:
        "Перегляньте користувачів, які очікують на надсилання особистих повідомлень у канали, захищені паруванням.",
      channelFilter: "Канал",
      ...
      expires: "Термін дії завершується {ago}",
      senderDetails: "Дані відправника",
      missingPermission:
        "Це з'єднання не має доступу operator.pairing, тому запити на особисті повідомлення не можна переглянути.",
      noAccounts:
        "Жоден з налаштованих облікових записів каналів не використовує парування відправників особистих повідомлень.",
      noRequests: "Немає запитів на доступ до особистих повідомлень, що очікують на розгляд.",
      noFilteredRequests: "Немає запитів, що очікують на розгляд, які відповідають цим фільтрам.",
      limits:
        "Термін дії запитів завершується через {minutes} хв. Кожен обліковий запис каналу може містити до {count} запитів, що очікують на розгляд.",
      detailTitle: "Доступ до особистих повідомлень",
      detailSubtitle:
        "Користувачі мають бути схвалені, перш ніж їхні прямі повідомлення досягнуть агента.",
      ...
      dismissExplanation:
        "Це видаляє поточний запит, але не блокує відправника. Він може запросити доступ пізніше.",
      ...
      approvedNotificationFailedNotice:
        "Доступ до прямих повідомлень схвалено, але сповіщення запитувача не вдалося доставити.",
      ...
      approvedFollowupsFailedNotice:
        "Доступ до прямих повідомлень схвалено, але сповіщення запитувача та налаштування власника команд не вдалися.",
      dismissedNotice:
        "Запит на доступ до прямих повідомлень відхилено. Відправник може запросити доступ знову.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Жодного збереженого сеансу WhatsApp не було очищено. Можливо, його вже немає, або його каталог автентифікації потребує ручного очищення.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Хмарні воркери потребують середовища виконання OpenClaw; вибрано {runtime}.",
    ...
    gitCheckUnavailable:
      "Не вдалося перевірити Git для цієї теки. Виберіть її ще раз, щоб повторити спробу.",
  ...
  sessionsView: {
    ...
    all: "Усі",
    sessionArchived: "Гілку заархівовано",
    ...
    noArchivedSessions: "Немає заархівованих сеансів.",
    ...
    cloudWorkerPlacementConflict: "Хмарний воркер: {state} · 1 конфлікт робочої області",
    cloudWorkerPlacementConflicts: "Хмарний воркер: {state} · {count} конфліктів робочих областей",
    cloudWorkerDescendantConflict: "Дочірній хмарний воркер: 1 конфлікт робочої області",
    cloudWorkerDescendantConflicts: "Дочірні хмарні воркери: {count} конфліктів робочих областей",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw в macOS. Дозвольте їх у Системні параметри > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Показувати активність агента наживо на бічній панелі",
      liveActivityHint:
        "Показувати останню активність асистента чи інструмента під активними сесіями.",
    },
    sessionObserver: {
      title: "Спостерігач сесій",
      hint: "Підсумовуйте тривалі сесії за допомогою невеликої допоміжної моделі.",
      toggle: "Спостерігач сесій",
      toggleHint: "Генерувати живі зведення стану для підписаних сесій Control UI.",
      ...
      disabled: "Вимкнено",
      toggleNote: "Оновити спостерігач сесій Control UI",
      modelNote: "Оновити допоміжну модель за замовчуванням",
    },
    connection: {
      title: "Підключення",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    security: "Автентифікація Gateway, політика виконання, профіль інструментів і затвердження.",
    advanced: "Усі решта розділів конфігурації, а також редактор вихідного файлу.",
  ...
  custodian: {
    ...
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, спочатку найновіші.",
      ...
      opaqueChange: "Форматування або коментарі змінено без видимих змін шляху конфігурації.",
      sources: {
  ...
  appsPage: {
    heroTitle: "Візьміть OpenClaw усюди з собою",
    heroTagline:
      "Супутні застосунки для вашого телефона, годинника, комп’ютера та браузера — а також плагіни для розширення можливостей вашого агента.",
    sectionMobile: "На вашому телефоні",
    havePhone: "Уже маєте застосунок?",
    pairDevice: "Створіть пару з пристроєм",
    ...
    badgeBundledIos: "Включено до застосунку iOS",
    badgeBundledAndroid: "Включено до застосунку Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і миттєві відповіді з вашого зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Компаньйон Android розширює OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
      ...
      linux: {
        title: "Linux",
        desc: "Нативний десктопний застосунок — збірки .deb та AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Показувати, хто онлайн",
    rosterTitle: "Онлайн",
    serverRegion: "Сервер",
    you: "ви",
  },
  ...
  gatewayLogs: {
    ...
    autoFollow: "Автоматичне стеження",
    file: "Файл: {file}",
    truncated: "Вивід журналу скорочено; показано останній фрагмент.",
    empty: "Немає записів у журналі.",
  },
  pluginTabs: {
  ...
  board: {
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Не вдалося авторизувати віджет після повторних спроб оновлення. Якщо gateway працює за зворотним проксі або тунелем, який не маршрутизує порт пісочниці віджета, встановіть mcp.apps.sandboxOrigin на виділене публічне джерело, маршрутизоване до слухача пісочниці.",
  ...
  workboard: {
    widget: {
      ...
      summaryLabel: "Зведення Workboard",
      loading: "Завантаження Workboard…",
      cardIdRequired: "Цьому віджету потрібна властивість cardId.",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Розгортання середовища…",
    ...
    board: {
      ...
      dockBottom: "Закріпити чат унизу",
      ...
      mockSourceMap: "Мапа джерел",
      resetTitle: "Скинути розмову?",
      resetDescription: "Контекст розмови буде скинуто. Ваша панель залишиться.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      morePaths: "+{count} інших шляхів",
      stagedResult: "Підготовлений хмарний результат",
      copyStagedResult: "Копіювати посилання на підготовлений результат",
      inspectCloud: "Переглянути першу хмарну версію",
      takeCloud: "Взяти першу хмарну версію",
      copyInspectCommand: "Копіювати команду перегляду хмари",
      copyTakeCommand: "Копіювати команду take-cloud",
      commandHelp:
        "Виконуйте їх у Bash або zsh (Git Bash у Windows). Якщо inspect повідомляє, що шлях не існує, то хмара його видалила; перевірте та видаліть локальний шлях вручну. Якщо checkout повідомляє про конфлікт файлу/каталогу, перемістіть або видаліть локальний шлях, що блокує, і повторіть спробу. Якщо підготовленого посилання немає, повідомлення застаріле; не змінюйте локальний шлях.",
      commandsUnavailable:
        "Ця назва файлу містить керуючі символи термінала, тому OpenClaw не створить для неї копійовану команду оболонки. Перегляньте підготовлене посилання безпосередньо та обережно введіть шлях вручну.",
      dismiss: "Закрити сповіщення про конфлікт робочого простору",
    ...
    questions: {
      ...
      ownAnswerFor: "Ваша власна відповідь для {header}",
    ...
    imageLightbox: {
      label: "Перегляд зображення: {title}",
      open: "Відкрити зображення {title}",
      openOriginal: "Відкрити оригінал",
      close: "Закрити перегляд зображення",
      untitled: "Зображення",
    },
    messages: {
      activity: "Активність",
      ...
      forkUnavailable: "Відгалуження недоступне, поки агент працює",
    ...
    observer: {
      title: "Спостерігач сесії",
      expand: "Розгорнути спостерігач сесії",
      collapse: "Згорнути спостерігач сесії",
      hide: "Приховати спостерігач сесії",
      show: "Показати спостерігач сесії",
      plan: "План",
      ...
      askLabel: "Запитати про цю сесію",
      askPlaceholder: "Чому воно так робить?",
    ...
    composer: {
      ...
      offlineHint:
        "Офлайн — повідомлення потраплятимуть у чергу й будуть надіслані після відновлення з'єднання.",
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може переліковувати камери.",
      ...
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в редакторі, продиктуйте текст, а потім відпустіть, щоб вставити текст без надсилання.",
      dictationAudioUnsupported: "Gateway повернув непідтримуваний аудіоформат диктування.",
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як вдалося завершити останню часткову транскрипцію.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Це обговорення неможливо вбудувати.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      script: "Скрипт",
      readOnlyPayloadHelp:
        "Цей payload було створено поза Control UI. Його вміст залишається доступним лише для читання й зберігається під час збереження інших змін.",
