...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      ...
      allAccounts: "Tất cả các tài khoản",
      approve: "Chấp thuận",
      dismiss: "Bỏ qua",
      approveAria: "Phê duyệt {sender} cho {channel}, tài khoản {account}",
      dismissAria: "Bỏ qua {sender} cho {channel}, tài khoản {account}",
      requested: "Đã yêu cầu {ago}",
      expires: "Hết hạn {ago}",
      senderDetails: "Chi tiết người gửi",
      missingPermission:
        "Kết nối này không có quyền truy cập operator.pairing, vì vậy không thể xem xét các yêu cầu DM.",
      noAccounts: "Không có tài khoản kênh nào được cấu hình sử dụng ghép nối người gửi DM.",
      noRequests: "Không có yêu cầu truy cập DM đang chờ xử lý.",
      noFilteredRequests: "Không có yêu cầu đang chờ nào khớp với các bộ lọc này.",
      limits:
        "Yêu cầu sẽ hết hạn sau {minutes} phút. Mỗi tài khoản kênh có thể giữ tối đa {count} yêu cầu đang chờ xử lý.",
      detailTitle: "Truy cập DM",
      detailSubtitle:
        "Mọi người phải được phê duyệt trước khi tin nhắn trực tiếp của họ đến được agent.",
      ...
      dismissExplanation:
        "Điều này loại bỏ yêu cầu hiện tại nhưng không chặn người gửi. Họ có thể yêu cầu truy cập lại sau.",
      notifyRequester: "Thông báo cho người yêu cầu sau khi phê duyệt",
      makeCommandOwner: "Đồng thời đặt người gửi này làm chủ lệnh đầu tiên",
      commandOwnerHelp:
        "Chủ lệnh có thể chạy các lệnh đặc quyền và phê duyệt các hành động nguy hiểm. Tùy chọn này chỉ khả dụng khi chưa có chủ nào được cấu hình.",
      commandOwnerNeedsAdmin:
        "Chưa có chủ lệnh nào được cấu hình. Kết nối này cần operator.admin để gán chủ đầu tiên.",
      approvedNotice: "Đã phê duyệt quyền truy cập DM.",
      approvedOwnerNotice: "Đã phê duyệt quyền truy cập DM và chủ lệnh đầu tiên đã được cấu hình.",
      ...
      approvedOwnerFailedNotice:
        "Đã phê duyệt quyền truy cập DM, nhưng không thể cấu hình chủ lệnh đầu tiên.",
      approvedFollowupsFailedNotice:
        "Đã phê duyệt quyền truy cập DM, nhưng cả thông báo cho người yêu cầu và thiết lập chủ lệnh đều thất bại.",
      dismissedNotice: "Đã bỏ qua yêu cầu truy cập DM. Người gửi có thể yêu cầu truy cập lại.",
    },
    setup: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Có thể nó đã không còn, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "Cloud worker cần runtime OpenClaw; {runtime} đang được chọn.",
    ...
    gitCheckUnavailable: "Không thể xác minh Git cho thư mục này. Chọn lại để thử lại.",
  ...
  sessionsView: {
    ...
    noActiveSessions: "Không có luồng hoạt động.",
    ...
    lastActive: "Hoạt động gần nhất {time}",
    surface: "Bề mặt",
    subject: "Chủ đề",
    room: "Phòng",
    space: "Không gian",
    ...
    cloudWorkerDescendantConflict: "Cloud worker con: 1 xung đột không gian làm việc",
    cloudWorkerDescendantConflicts: "Cloud worker con: {count} xung đột không gian làm việc",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG hoặc WebP. Ảnh được cắt ở giữa và thay đổi kích thước về 512px.",
      profileLoadFailed: "Không thể tải hồ sơ của bạn.",
      profileSaveFailed: "Không thể lưu hồ sơ của bạn.",
      avatarInvalid: "Chọn ảnh JPEG, PNG hoặc WebP hợp lệ.",
  ...
  configView: {
    ...
    sessionObserver: {
      ...
      modelPickerHint:
        "Được dùng cho bản tóm tắt của trình quan sát và các tác vụ tiện ích ngắn khác.",
  ...
  custodian: {
    ...
    newAgent: "Agent mới",
    hatchDraft: "Tỉnh dậy nào, bạn của tôi!",
    ...
    history: {
      ...
      invalidEdit: "Chỉnh sửa thủ công này không vượt qua xác thực cấu hình.",
      opaqueChange:
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} vừa bị ngắt kết nối — hãy hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpServers: {
    ...
    targetInvalid: "Nhập URL cho transport HTTP hoặc một dòng lệnh hợp lệ cho stdio.",
  ...
  labsPage: {
    ...
    sectionDescription: "Thay đổi được lưu ngay và áp dụng cho các lần chạy agent trong tương lai.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript nhỏ gọn, được cách ly sandbox.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "Mang OpenClaw đi mọi nơi",
    heroTagline:
    ...
    badgeBundledAndroid: "Đã bao gồm trong ứng dụng Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh cuộc trò chuyện và trả lời nhanh ngay trên cổ tay bạn.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        ...
        desc: "Để OpenClaw điều khiển Chrome hiện có của bạn — tab, trang và biểu mẫu.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "Địa chỉ email được kết nối với hồ sơ này.",
      openSettings: "Mở cài đặt danh tính cho {name}",
      avatarErrors: {
        invalid: "Không thể xử lý hình ảnh đó.",
        sourceTooLarge: "Chọn hình ảnh có kích thước 10 MB hoặc nhỏ hơn.",
  ...
  board: {
    ...
    tabsLabel: "Các tab bảng điều khiển",
    ...
    widget: {
      cellLabel:
        "Widget bảng điều khiển: {title}. Dùng phím mũi tên để di chuyển. Giữ Alt và nhấn phím mũi tên để di chuyển widget.",
      ...
      rejectedDetail: "Widget này vẫn không hoạt động cho đến khi bị xóa hoặc thay thế.",
      ...
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu gateway chạy sau reverse proxy hoặc tunnel không định tuyến cổng sandbox của widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai riêng được định tuyến tới listener sandbox.",
      errorTitle: "Không thể tải widget này",
      errorDetail: "Sự cố chỉ giới hạn ở thẻ này.",
      actionErrorTitle: "Thay đổi widget thất bại",
      actionErrorDetail: "Bảng điều khiển vẫn giữ trạng thái widget trước đó.",
  ...
  workboard: {
    widget: {
      ...
      noActiveCards: "Không có thẻ sẵn sàng hoặc đang chạy.",
    },
    ...
    dashboardEmpty: "Chưa có bảng điều khiển — agent đang làm việc có thể ghim widget.",
    openSession: "Mở phiên",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      startingModel: "Đang khởi động model…",
    },
    outputTokens: "{count} token đầu ra",
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Việc chuyển nhánh yêu cầu quyền quản trị operator.",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw đã giữ các phiên bản cục bộ của bạn và áp dụng các thay đổi trên đám mây khác. Kiểm tra kết quả đã dàn dựng hoặc lấy phiên bản của nó cho một đường dẫn bị xung đột.",
      morePaths: "+{count} đường dẫn khác",
      stagedResult: "Kết quả đám mây đã dàn dựng",
      copyStagedResult: "Sao chép tham chiếu kết quả đã dàn dựng",
      ...
      copyTakeCommand: "Sao chép lệnh lấy từ đám mây",
      commandHelp:
        "Chạy các lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu lệnh kiểm tra báo đường dẫn không tồn tại, đám mây đã xóa nó; hãy xác minh và xóa đường dẫn cục bộ thủ công. Nếu checkout báo xung đột tệp/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang chặn, rồi thử lại. Nếu tham chiếu đã dàn dựng bị thiếu, thông báo đã cũ; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tệp này chứa các ký tự điều khiển terminal, nên OpenClaw sẽ không tạo lệnh shell có thể sao chép cho nó. Hãy kiểm tra tham chiếu đã dàn dựng trực tiếp và nhập đường dẫn thủ công một cách cẩn thận.",
      ...
      eventDescription:
        "Các phiên bản cục bộ đã được giữ cho các đường dẫn này; các thay đổi đám mây khác đã được áp dụng.",
    },
    compaction: {
    ...
    messages: {
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Tác nhân vẫn nhìn thấy nó.",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản chép một phần cuối cùng được hoàn tất.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Tập lệnh",
      readOnlyPayloadHelp:
        "Tải trọng này được tạo bên ngoài Control UI. Nội dung của nó ở chế độ chỉ đọc và được giữ nguyên khi bạn lưu các thay đổi khác.",
